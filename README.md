...
- хост может выдать участнику управление, тогда его пауза, перемотка и смена
  трека расходятся по всей комнате
- список участников с отметками кто ведёт, кто управляет и у кого идёт загрузка
...
| mashiro.hiddenPlaylists                      | список скрытых плейлистов               |
