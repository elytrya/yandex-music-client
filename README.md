...
### слушать вместе (в разработке)

- совместное прослушивание по локальной сети или через любой vpn с общей подсетью
- подходят radmin vpn, hamachi, zerotier, tailscale, netbird и любой другой
  туннель, где участники видят ip друг друга
- один участник ведёт, остальные повторяют трек, паузу и позицию
...
- комната поднимается прямо в клиенте, отдельный сервер не нужен
